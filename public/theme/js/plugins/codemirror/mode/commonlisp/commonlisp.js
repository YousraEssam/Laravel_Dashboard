    ...
    CodeMirror.defineMode("commonlisp", function (config) {
        ...
        function base(stream, state)
        {
            ...
            if (ch == '"') {
                ...
                type = "open"; return "bracket"; } else if (ch == ")" || ch == "]") {
                        type = "close"; return "bracket"; } else if (ch == ";") {
                    stream.skipToEnd(); type = "ws"; return "comment"; } else if (/['`,@]/.test(ch)) {
                            return null;
                    } else if (ch == "|") {
                        if (stream.skipTo("|")) {
                            stream.next(); return "symbol"; } else {
                              stream.skipToEnd(); return "error"; }
                    } else if (ch == "#") {
                            var ch = stream.next();
                        if (ch == "[") {
                            type = "open"; return "bracket"; } else if (/[+\-=\.']/.test(ch)) {
                            return null;
                                ...
                                readSym(stream); return "meta"; } else {
                                return "error";
                                }
                    } else {
