...
(function (mod) {
  ...
  // Return variables for tokenizers
        ...
        {
            if (type == "openPlugin") {
                curState.pluginName = pluginName; return cont(attributes, endplugin(curState.startOfLine));} else if (type == "closePlugin") {
                      var err = false;
                if (curState.context) {
        ...
        function endplugin(startOfLine)
        {
            return function (type) {
                ...
                if (type == "endPlugin") {
                    pushContext(curState.pluginName, startOfLine); return cont();}
                return cont();
            };
        }
