...
(function ($) {
    ...
    $.fn.justifiedGallery = function (options) {
        ...
        function buildImage(image, suffix, nw, nh, l, minRowHeight, settings)
        {
            ...
            if (typeof image["rel"] != 'undefined') {
                ris += "rel=\"" + image["rel"] + "\"";
            }
            if (typeof image["target"] != 'undefined') {
                ris += "target=\"" + image["target"] + "\"";
            }
