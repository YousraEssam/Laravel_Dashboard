                    ...
                    <div class="row">
                        <div class="col-sm-12 b-r">
                            ...
                            <form role="form" method="POST"
                                action="{{ route('library.files.images.update', [$folder->id, $folder->image->id]) }}"
                                ...
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" value="{{ $folder->image->name }}" class="form-control"
                                        name="name" id="name">
                                </div>

                                <div class="form-group">
                                    <label>Description</label>
                                    <input type="text" value="{{ $folder->image->description }}" class="form-control"
